package sachwini.springframework.Spring5RecipeApp.bootsrap;
...
import sachwini.springframework.domain.*;
import sachwini.springframework.Repositories.CategoryRepository;
import sachwini.springframework.Repositories.RecipeRepository;
import sachwini.springframework.Repositories.UnitOfMeasureRepository;
...
//        quacRecipe.getIngredients().add(new Ingredient("ripe avocados", new BigDecimal(2), eachUom, quacRecipe));
        ...
        quacRecipe.addIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), teaSpoonUom));
